...
CREATE TYPE username_namespace AS ENUM ('email', 'employee', 'admin');
...
CREATE TABLE public.user (
	...
	username_namespace username_namespace NOT NULL,
	...
	CONSTRAINT chk_user_group_username_namespace CHECK (
		((user_group = 'customer' OR user_group = 'entrepreneur') AND username_namespace = 'email')
		OR
		(user_group = 'employee' AND username_namespace = 'employee')
		OR
		((user_group = 'head_admin' OR user_group = 'regular_admin') AND username_namespace = 'admin')
	),
	CONSTRAINT uk_user_username_namespace_username UNIQUE (username_namespace, username),
