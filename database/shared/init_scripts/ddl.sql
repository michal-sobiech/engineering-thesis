...
CREATE TABLE public.enterprise (
	...
	logo_photo_id bigint, 
	background_photo_id bigint,
	CONSTRAINT pk_enterprise PRIMARY KEY (enterprise_id),
	CONSTRAINT fk_enterprise_location_id FOREIGN KEY (location_id) REFERENCES public.location(location_id) ON DELETE CASCADE,
	...
	CONSTRAINT fk_enterprise_logo_photo_id FOREIGN KEY (logo_photo_id) REFERENCES public.photo(photo_id) ON DELETE SET NULL,
	CONSTRAINT fk_enterprise_background_photo_id FOREIGN KEY (background_photo_id) REFERENCES public.photo(photo_id) ON DELETE SET NULL
);
...
CREATE TABLE public.enterprise_service (
	...
	CONSTRAINT fk_location_id FOREIGN KEY (location_id) REFERENCES public.location(location_id) ON DELETE SET NULL,
	CONSTRAINT chk_custom_appointments CHECK (
		(location_id IS NULL AND takes_custom_appointments = TRUE)
		or 
		(location_id IS NOT NULL AND takes_custom_appointments = FALSE)
	)
);
