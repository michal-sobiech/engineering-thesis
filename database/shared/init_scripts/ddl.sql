...
CREATE TABLE public.enterprise (
	enterprise_id bigint GENERATED ALWAYS AS IDENTITY NOT NULL,
...
CREATE TABLE public.enterprise_service (
	enterprise_service_id bigint GENERATED ALWAYS AS IDENTITY NOT NULL,
...
CREATE TABLE public.enterprise_service_slot_template (
	enterprise_service_slot_template_id bigint GENERATED ALWAYS AS IDENTITY NOT NULL,
...
CREATE TABLE public.review (
	...
	CONSTRAINT fk_review_subject_enterprise_service_id FOREIGN KEY (subject_enterprise_service_id) REFERENCES public.enterprise_service(enterprise_service_id) ON DELETE CASCADE,
