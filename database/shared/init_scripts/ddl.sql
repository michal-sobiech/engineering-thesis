...
CREATE TABLE public.enterprise_service (
	...
	CONSTRAINT pk_enteprise_service PRIMARY KEY (enterprise_service_id),
	CONSTRAINT chk_custom_appointments CHECK (
		("location" IS NULL AND takes_custom_appointments = TRUE)
		or 
		("location" IS NOT NULL AND takes_custom_appointments = FALSE)
	)
);
