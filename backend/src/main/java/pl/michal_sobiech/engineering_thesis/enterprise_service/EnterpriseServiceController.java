...
public class EnterpriseServiceController implements ServicesApi {
    ...
    @Override
    public ResponseEntity<GetEnterpriseServiceResponse> getEnterpriseService(Long enterpriseServiceId) {
        EnterpriseServiceEntity enterpriseService = enterpriseServiceService.getById(enterpriseServiceId).orElseThrow();
        GetEnterpriseServiceResponse body = new GetEnterpriseServiceResponse(
                enterpriseService.getEnterpriseServiceId(),
                enterpriseService.getName(),
                enterpriseService.getDescription(),
                new Location(
                        enterpriseService.getAddress(),
                        enterpriseService.getLongitude(),
                        enterpriseService.getLatitude()),
                enterpriseService.getTimeZone().toString(),
                enterpriseService.isTakesCustomAppointments(),
                enterpriseService.getMaxDistanceKm(),
                enterpriseService.getCathegory().toString(),
                enterpriseService.getPrice(),
                enterpriseService.getCurrency().toString());
        return ResponseEntity.ok(body);
    }
