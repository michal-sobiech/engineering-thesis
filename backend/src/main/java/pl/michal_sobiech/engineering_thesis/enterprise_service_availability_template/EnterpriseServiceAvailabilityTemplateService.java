package pl.michal_sobiech.engineering_thesis.enterprise_service_availability_template;
...
public class EnterpriseServiceAvailabilityTemplateService {
    ...
    public List<LocalTimeWindow> getAvailabilityTemplateForDayOfWeek(
        ...
        return enterpriseServiceSlotTemplateService.getAvailabilityTemplateForDayOfWeek(enterpiseServiceId, dayOfWeek)
                .stream()
                .map(slotTemplate -> new LocalTimeWindow(slotTemplate.getStartTime(), slotTemplate.getEndTime()))
                .collect(Collectors.toList());
    }
}
